...
export function FeaturedHeroCarousel({ items }: FeaturedHeroCarouselProps) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pt-3 pb-2 md:px-8 md:pt-6 md:pb-4">
      ...
      <div
        className="relative w-full h-[250px] sm:h-[280px] md:h-[310px] lg:h-[330px] rounded-3xl overflow-hidden border border-white/10 bg-[#08090E] shadow-2xl group select-none"
      ...
      >
        ...
        {items.map((manga, idx) => {
          ...
          const coverUrl = getOptimizedImageUrl(manga.cover_url);
          return (
            <div
              key={manga.slug}
            ...
            >
              {coverUrl && (
                <>
                  ...
                  <div className="absolute right-0 top-0 bottom-0 w-[55%] xs:w-[52%] sm:w-[50%] md:w-[48%] lg:w-[45%] h-full overflow-hidden pointer-events-none">
                    ...
                    />
                    {/* Gradient blending the artwork seamlessly into the dark background on the left */}
                    <div className="absolute inset-0 bg-gradient-to-r from-[#08090E] via-[#08090E]/50 via-15% to-transparent" />
              ...
              <div className="absolute inset-y-0 left-0 w-[65%] sm:w-[55%] bg-gradient-to-r from-[#08090E] via-[#08090E] to-transparent z-[1] pointer-events-none" />
            </div>
          );
        })}

        {/* Content Overlaid on Landscape Card */}
        <div className="relative z-10 h-full flex flex-col justify-between p-4 sm:p-7 md:p-8 max-w-full sm:max-w-lg lg:max-w-xl text-left">
          {/* Top Badges */}
          ...
          {/* Title & Description */}
          <div className="my-auto py-1 max-w-[72%] sm:max-w-md">
            ...
            <p className="mt-1 text-xs sm:text-sm text-zinc-300 line-clamp-2 font-noto leading-relaxed opacity-90 drop-shadow-sm">
            ...
            <div className="flex items-center gap-2.5">
              <Link
                ...
                onClick={() => {
                  ...
                  triggerStartLoading();
                  setTimeout(() => {
                    setOpeningChapter((cur) => (cur === activeManga.slug ? null : cur));
                  }, 3500);
                }}
